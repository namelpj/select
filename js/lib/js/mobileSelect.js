...
window.MobileSelect = (function() {
	...
	MobileSelect.prototype = {
		...
		init: function(config){
			...
			_this.ensureBtn = _this.mobileSelect.querySelector('.btnsure');
			//_this.closeBtn = _this.mobileSelect.querySelector('.cancel');
			_this.closeBtn = _this.mobileSelect.querySelector('.close ');
			//_this.grayLayer = _this.mobileSelect.querySelector('.grayLayer');
			_this.popUp = _this.mobileSelect.querySelector('.selectContent');
		...
		renderWheels: function(wheelsData){
			...
			_this.mobileSelect.innerHTML = 
				...
				'<section class="meta">'+
				    '<h2 class="hottitle">热门城市</h2>'+
				    '<a class="close ico-cls" href="javascript:void(0)"></a>'+
				'</section>'+

				'<ul class="hot-list clearfix">'+
				     '<li hotcity="北京市" hotprovince="北京" class="">北京市</li>'+
				     '<li hotcity="上海市" hotprovince="上海" class="">上海市</li>'+
				     '<li hotcity="杭州市" hotprovince="浙江省" class="">杭州市</li>'+
				     '<li hotcity="广州市" hotprovince="广东省" class="">广州市</li>'+
				     '<li hotcity="深圳市" hotprovince="广东省" class="">深圳市</li>'+
				     '<li hotcity="东莞市" hotprovince="广东省" class="">东莞市</li>'+
				'</ul>'+


				'<section class="meta-two">'+
				     '<h2 class="hottitle">省市区选择</h2>'+
				'</section>'+
